jQuery("#simulation")
  .on("click", ".s-4a526d47-3245-46fb-a285-4336088dfc3d .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-4a526d47-3245-46fb-a285-4336088dfc3d #s-raised_Button > .backgroundLayer": {
                      "attributes": {
                    ...
                    "#s-4a526d47-3245-46fb-a285-4336088dfc3d #s-raised_Button": {
                      "attributes": {
                        "text-shadow": "none"
                      }
                    }
  ...
  .on("focusin", ".s-4a526d47-3245-46fb-a285-4336088dfc3d .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-4a526d47-3245-46fb-a285-4336088dfc3d .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();

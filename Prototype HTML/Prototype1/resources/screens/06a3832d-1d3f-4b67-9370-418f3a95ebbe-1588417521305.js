jQuery("#simulation")
  .on("click", ".s-06a3832d-1d3f-4b67-9370-418f3a95ebbe .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-06a3832d-1d3f-4b67-9370-418f3a95ebbe #s-raised_Button > .backgroundLayer": {
                      "attributes": {
                    ...
                    "#s-06a3832d-1d3f-4b67-9370-418f3a95ebbe #s-raised_Button": {
                      "attributes": {
                        "text-shadow": "none"
                      }
                    }
  ...
  .on("pageunload", ".s-06a3832d-1d3f-4b67-9370-418f3a95ebbe .pageunload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-06a3832d-1d3f-4b67-9370-418f3a95ebbe .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-06a3832d-1d3f-4b67-9370-418f3a95ebbe .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();

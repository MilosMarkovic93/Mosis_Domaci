jQuery("#simulation")
  .on("click", ".s-109ad32e-82d7-4aed-b3e0-afd3f1b5bc70 .click", function(event, data) {
  ...
  .on("focusin", ".s-109ad32e-82d7-4aed-b3e0-afd3f1b5bc70 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-109ad32e-82d7-4aed-b3e0-afd3f1b5bc70 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();

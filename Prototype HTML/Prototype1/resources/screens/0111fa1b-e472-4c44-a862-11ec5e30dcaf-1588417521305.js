jQuery("#simulation")
  .on("click", ".s-0111fa1b-e472-4c44-a862-11ec5e30dcaf .click", function(event, data) {
  ...
  .on("focusin", ".s-0111fa1b-e472-4c44-a862-11ec5e30dcaf .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-0111fa1b-e472-4c44-a862-11ec5e30dcaf .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();

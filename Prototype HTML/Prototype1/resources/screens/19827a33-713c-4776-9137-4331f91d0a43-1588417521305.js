jQuery("#simulation")
  .on("click", ".s-19827a33-713c-4776-9137-4331f91d0a43 .click", function(event, data) {
  ...
  .on("focusin", ".s-19827a33-713c-4776-9137-4331f91d0a43 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-19827a33-713c-4776-9137-4331f91d0a43 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();

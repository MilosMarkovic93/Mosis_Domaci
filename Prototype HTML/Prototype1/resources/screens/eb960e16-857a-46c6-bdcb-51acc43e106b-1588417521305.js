jQuery("#simulation")
  .on("click", ".s-eb960e16-857a-46c6-bdcb-51acc43e106b .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/56ef7aa7-68a4-40ea-9565-e4c1e38e7e54"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("focusin", ".s-eb960e16-857a-46c6-bdcb-51acc43e106b .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-eb960e16-857a-46c6-bdcb-51acc43e106b .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();

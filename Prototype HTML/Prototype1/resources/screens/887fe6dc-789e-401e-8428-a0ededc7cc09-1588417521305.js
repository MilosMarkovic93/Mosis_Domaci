jQuery("#simulation")
  .on("click", ".s-887fe6dc-789e-401e-8428-a0ededc7cc09 .click", function(event, data) {
  ...
  .on("focusin", ".s-887fe6dc-789e-401e-8428-a0ededc7cc09 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-887fe6dc-789e-401e-8428-a0ededc7cc09 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();

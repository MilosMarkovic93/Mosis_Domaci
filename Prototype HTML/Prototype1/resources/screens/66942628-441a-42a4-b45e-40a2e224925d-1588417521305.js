jQuery("#simulation")
  .on("click", ".s-66942628-441a-42a4-b45e-40a2e224925d .click", function(event, data) {
  ...
  .on("swipeleft", ".s-66942628-441a-42a4-b45e-40a2e224925d .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swiperight", ".s-66942628-441a-42a4-b45e-40a2e224925d .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();

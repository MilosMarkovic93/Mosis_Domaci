jQuery("#simulation")
  .on("click", ".s-f681e7f1-6237-4c8c-b099-b65e7619a93c .click", function(event, data) {
  ...
  .on("pageload", ".s-f681e7f1-6237-4c8c-b099-b65e7619a93c .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Label_name_2")) {
      cases = [
        {
          "blocks": [
            {
